...
export default function Certifications() {
  ...
  const certs = [
    ...
    // ============ OTHERS CATEGORY ============
    { id: "UC-3f32f1ff", category: "Others", title: "LEARN PYTHON BY MAKING GAMES", provider: "Udemy", score: "COMPLETED", date: "June 2023", icon: "logos:python", skills: ["Python", "Game Dev", "Logic"], pdf: "/certificates/UC-3f32f1ff-e199-468c-9dd1-47109ad3ead8.pdf" },
